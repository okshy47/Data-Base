...
// تعريف أنواع الأوضاع الخمسة التي اخترتها في الصورة
...
export const Logo: React.FC<LogoProps> = ({ theme, size = 200, showText = true }) => {
  // 1. إعداد مصفوفة الألوان والتدرجات بناءً على صورتك المقترحة تماماً
  const themeStyles = {
    'dark-blue': {
    ...
    'emerald': {
      ...
      files: '#D1FAE5',        // أوراق خضراء فاتحة جداً
  ...
  return (
    <div style={{ 
      ...
      {showText && (
        <div style={{ textAlign: 'center', marginTop: '20px', fontFamily: 'system-ui, sans-serif', direction: 'rtl' }}>
          <h1 style={{ 
